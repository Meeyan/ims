...
(function ($) {
    ...
    $.fn.pagination.parseOptions = function (_d0) {
        var t = $(_d0);
        return $.extend({}, $.parser.parseOptions(_d0, [{total: "number", pageSize: "number", pageNumber: "number", links: "number"}, {
            loading: "boolean",
...
(function ($) {
    ...
    $.fn.tree.parseOptions = function (_1bb) {
        var t = $(_1bb);
        return $.extend({}, $.parser.parseOptions(_1bb, ["url", "method", {checkbox: "boolean", cascadeCheck: "boolean", onlyLeafCheck: "boolean"}, {
            animate: "boolean",
            lines: "boolean",
            dnd: "boolean"
        }]));
...
(function ($) {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, onSelect: function (_319, _31a) {
...
(function ($) {
    ...
    function _351(_352, _353, pp) {
        ...
        pp.panel($.extend({}, _353, {
            tab: tab, border: false, noheader: true, closed: true, doSize: false, iconCls: (_353.icon ? _353.icon : undefined), onLoad: function () {
                if (_353.onLoad) {
    ...
    $.fn.tabs.parseOptions = function (_399) {
        return $.extend({}, $.parser.parseOptions(_399, ["tools", "toolPosition", "tabPosition", {fit: "boolean", border: "boolean", plain: "boolean"}, {
            headerWidth: "number",
            tabWidth: "number",
            tabHeight: "number",
            selected: "number"
...
(function ($) {
    ...
    function _3b9(_3ba, _3bb, el) {
        ...
        _3c1.resizable($.extend({}, {
            handles: (_3c0[dir] || ""), disabled: (!pp.panel("options").split), onStartResize: function (e) {
                _3a9 = true;
    ...
    function _3cb(_3cc, _3cd, _3ce) {
        ...
        function _3d4() {
            ...
            if (_3cd == "east") {
                ...
                return {
                    resizeC: {width: _3db},
                    expand: {left: cc.width() - _3da},
                    expandP: {top: _3d8.top, left: cc.width() - _3d9, width: _3d9, height: _3d8.height},
                ...
                if (_3cd == "west") {
                    ...
                    return {
                        resizeC: {width: _3db, left: _3d9 - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3d8.top, width: _3d9, height: _3d8.height},
                        collapse: {left: -_3da, top: _3d8.top, height: _3d8.height}
                    };
                } else {
                    if (_3cd == "north") {
                        ...
                        return {
                            resizeC: {top: _3d9 - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _3d9},
                            collapse: {top: -_3dc, width: cc.width()}
                        };
                    } else {
                        if (_3cd == "south") {
                            var _3dc = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _3dc},
                                expandP: {top: cc.height() - _3d9, left: 0, width: cc.width(), height: _3d9},
    ...
    $.fn.layout.defaults = {
        fit: false, onExpand: function (_3fe) {
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        region: null, split: false, collapsedSize: 28, expandMode: "float", hideExpandTool: false, hideCollapsedContent: true, collapsedContent: function (_403) {
            var p = $(this);
...
(function ($) {
    ...
    function _40d(_410, div, _411) {
        var item = $(div);
        var _412 = $.extend({}, $.parser.parseOptions(item[0], ["id", "name", "iconCls", "href", {separator: "boolean"}]), {
    ...
    $.fn.menu.parseOptions = function (_459) {
        return $.extend({}, $.parser.parseOptions(_459, [{minWidth: "number", itemHeight: "number", duration: "number", hideOnUnhover: "boolean"}, {
            fit: "boolean",
            inline: "boolean",
            noline: "boolean"
        }]));
    ...
    $.fn.menu.defaults = {
        ...
        fit: false,
        noline: false,
        events: {mouseenter: _41e, mouseleave: _421, mouseover: _425, mouseout: _428, click: _42a},
...
(function ($) {
    ...
    $.fn.switchbutton.parseOptions = function (_4a2) {
        var t = $(_4a2);
        return $.extend({}, $.parser.parseOptions(_4a2, ["onText", "offText", "handleText", {handleWidth: "number", reversed: "boolean"}]), {
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        ...
        events: {
            focus: _4ab, blur: _4af, mouseenter: _4b2, mouseleave: _4b5, click: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: {focus: _543, blur: _547}, val: function (_550) {
...
(function ($) {
    ...
    function load(_587, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _588, dataType: "json", success: function (data) {
                    _589(data);
                }, error: function () {
...
(function ($) {
    function _5f1(_5f2) {
        ...
        $(_5f2).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _5f4, doSize: false, onResize: function (_5f6, _5f7) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
...
(function ($) {
    ...
    function _67a(_67b) {
        ...
        _67d.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_67e, _67f) {
        ...
        if (opts.pagination) {
            ...
            _682.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_683, _684) {
    ...
    function _691(_692) {
        ...
        _697.each(function () {
            $(this).resizable({
                handles: _698, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _693.resizing = true;
    ...
    function _6d9(_6da) {
        ...
        function _6de() {
            ...
            $.map(_6e7, function (_6e8) {
                ...
                if (col && String(col.width || "").indexOf("%") >= 0) {
        ...
        function _6e2(col) {
            ...
            if (col && !col.hidden && !col.checkbox && !col.auto && !col.fixed) {
                return true;
            }
        };
    };
            ...
            if (col && col.editor) {
                ...
                if (_778) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _778,
                        target: _778.init(cell.find("td"), $.extend({height: opts.editorHeight}, _777)),
                        field: _775,
                        type: _776,
                        oldHtml: _779
                    });
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 24,
        headerEvents: {mouseover: _69b(true), mouseout: _69b(false), click: _69f, dblclick: _6a4, contextmenu: _6a7},
        rowEvents: {mouseover: _6a9(true), mouseout: _6a9(false), click: _6b0, dblclick: _6ba, contextmenu: _6be},
        ...
        loader: function (_859, _85a, _85b) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _859, dataType: "json", success: function (data) {
                    _85a(data);
                }, error: function () {
...
(function ($) {
    ...
    function _893(_894) {
        ...
        $(_894).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_896, row) {
...
(function ($) {
    function _8e0(_8e1) {
        ...
        if (opts.pagination) {
            ...
            _8ed.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_8ee, _8ef) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        singleSelect: true,
        view: _985,
        rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, {mouseover: _8fb(true), mouseout: _8fb(false), click: _8fd}),
        loader: function (_9c3, _9c4, _9c5) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _9c3, dataType: "json", success: function (data) {
                    _9c4(data);
                }, error: function () {
    ...
    function _9d1(_9d2) {
        ...
        $(_9d2).datagrid($.extend({}, opts, {
            ...
            columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_9d3, row, _9d4) {
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _a05, keydown: _a09, paste: _a09, drop: _a09},
        panelWidth: null,
        panelHeight: 200,
        panelMinWidth: null,
        panelMaxWidth: null,
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_a90) {
            return _a90;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, view: _a8b, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _a93, dataType: "json", success: function (data) {
                    _a94(data);
                }, error: function () {
...
(function ($) {
    function _b32(_b33) {
        ...
        $(_b33).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_b35, _b36) {
                _b37();
